...
| <a name="input_which_lambda_function"></a> [which\_lambda\_function](#input\_which\_lambda\_function) | Identify which function to invoke in lammbda module (password\_rotation, log\_exportation, another\_funtion) | `string` | n/a | yes |
