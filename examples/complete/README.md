...
| <a name="module_export_logs_lambda"></a> [export\_logs\_lambda](#module\_export\_logs\_lambda) | ../.. | n/a |
| <a name="module_password_lambda"></a> [password\_lambda](#module\_password\_lambda) | ../.. | n/a |
...
| <a name="input_enable_cloudwatch_logs_export"></a> [enable\_cloudwatch\_logs\_export](#input\_enable\_cloudwatch\_logs\_export) | If true, a lambda function will be created to export cloudwatch logs to s3 | `bool` | `true` | no |
| <a name="input_enable_password_rotation"></a> [enable\_password\_rotation](#input\_enable\_password\_rotation) | If true, a lambda function will be created to rotate passwords for the bastion | `bool` | `true` | no |
